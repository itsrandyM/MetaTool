...
const AddToken = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <div className={`overlay ${isOpen ? 'open' : ''}`} style={{ position: 'fixed', width: '100%', height: '100%', backgroundColor: 'rgba(0, 0, 0, 0.5)', zIndex: 999, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
