...
const Form1 = ({ onNextForm }) => {
  ...
  return (
    <div style={{ backgroundColor: '#F2EEE3', padding: '10px', borderRadius: '10px', color: 'black', marginLeft: 'auto', marginRight: 'auto', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.2)', textAlign: 'center', maxWidth: '300px', marginTop: '30px' }}>
      <div className="form1">
